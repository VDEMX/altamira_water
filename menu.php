   ...
   <li <?php if ($active_page=="productos") echo " class='active has-sub'"; elseif($active_page!=="productos") echo "class='has-sub'"?>><a><span>Productos</span></a>
      <ul>
         <li class="has-sub"><a href="#"><span>Bombas Sumergibles para Pozo</span></a>
            <ul>
               <li class="boton"><a href="vde/bkor.html" target="contenido"><span>Bombas Altamira Serie KOR (Acero Inoxidable)</span></a></li>
         ...
         <li class="has-sub"><a href="#"><span>Bombas Sumergibles para Aguas Residuales</span></a>
         	<ul>
         		<li class="boton"><a href="vde/bac.html" target="contenido"><span>Bombas para Achique (Efluentes)</span> </a></li>
         		<li class="boton"><a href="vde/bal.html" target="contenido"><span>Bombas para Lodos</span></a></li>
         		<li class="boton"><a href="vde/triturador.html" target="contenido"><span>Bombas para Lodos (Trituradora)</span></a></li>
         	</ul>
         </li>
         <li class="has-sub"><a href="#"><span>Bombas de Superficie</span></a>
         	<ul>
         		...
         		<li class="boton"><a href="vde/fps.htm" target="contenido"><span>Uso Agrícola</span></a></li>
         	</ul>
         </li>
         ...
         <li class="has-sub"><a href="#"><span>Presurizadores</span></a>
         	<ul>
         		...
         		<li class="has-sub"><a href="#"><span>Presurizador Presión Constante</span></a>
         			<ul>
         				<li  class="boton"><a href="vde/tecnoplus.html" target="contenido"><span>Tecnoplus</span></a></li>
         				<li class="has-sub"><a href="#"><span>Una Bomba</span></a>
         					<ul>
         						<li  class="boton"><a href="vde/wvmultiple.html" target="contenido"><span>Water Variat - Espa</span></a></li>
         						<li  class="boton"><a href="vde/fmultiple.html" target="contenido"><span>SubDrive</span></a></li>
         					</ul>
         				</li>
         				<li class="has-sub"><a href="#"><span>MultiBomba</span></a>
         					<ul>
         						<li  class="boton"><a href="vde/wvmultiple2.html" target="contenido"><span>Water Variat - Espa</span></a></li>
         						<li  class="boton"><a href="vde/presctealtamira.html" target="contenido"><span>Altamira AX y TX</span></a></li>
         						<li  class="boton"><a href="vde/presctealtamirae.html" target="contenido"><span>Altamira - Espa</span></a></li>
         ...
         <li class="has-sub"><a href="#"><span>Variadores de velocidad</span></a>
         	<ul>
         		<li  class="boton"><a href="vde/variadorv.html" target="contenido"><span>Water Variat</span></a></li>
         		<li  class="boton"><a href="vde/subdrive.html" target="contenido"><span>SubDrive</span></a></li>
         ...
         <li class="last has-sub"><a href="#"><span>Accesorios</span></a>
         	<ul>
         		...
         		<li class="boton"><a href="vde/controlp.html" target="contenido"><span>Control Automático de Presión</span></a></li>
         		<li class="boton"><a href="vde/accesorio_menores.html" target="contenido"><span>Válvulas, Manómetros, Switch de Presión, etc.</span></a></li>
         		<li class="boton"><a href="vde/cable.html" target="contenido"><span>Cable Sumergible</span></a></li>
